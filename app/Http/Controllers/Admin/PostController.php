...
class PostController extends Controller
{
    ...
    {
        $posts = Post::all();
        return view('back-end.admin.post.index',compact('posts'));
    }
    ...
    public function create()
    {
        ...
        $tag = Tag::all();
        return view('back-end.admin.post.create',compact('category','tag'));
    }
    ...
    {
        $posts = Post::find($id);
        return view('back-end.admin.post.edit',compact('posts'));
    }
