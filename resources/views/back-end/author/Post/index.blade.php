    ...
    <section class="content">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <a type="button" href="{{  route('authorpost.create') }}" class="btn btn-danger"><i class="material-icons">add</i></a>
                <div class="card">
                    <div class="header">
                        <h2>
                            Tag Post Table
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($posts as $row)
                                    <tr>
                                        ...
                                        <td><a type="button" name="edit" href="{{ route('authorpost.edit',$row->id) }}" class="btn btn-success waves-effect"><i class="material-icons">edit</i></a></td>
                                        <td><a type="button" name="delete" class="btn btn-danger waves-effect" onclick="
                                            ...
                                            <form method="post" action="{{ route('authorpost.destroy',$row->id) }}" id="delete-form-{{ $row->id }}">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </td>
