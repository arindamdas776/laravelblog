...
@section('title','Author Pending post')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($row->is_approve ==false)
                                                <a type="button" class="btn btn-danger wave-effect"onclick="
                                                    if(confirm('Are You sure to Approve The post ?')){
                                                    document.getElementById('post-approve-{{ $row->id }}').submit();
                                                    }else{
                                                    event.preventDefault();
                                                    }
                                                    "><i class="material-icons">remove</i>
                                                    <form method="post" id="post-approve-{{ $row->id }}" action="{{ route('adminpost.approve',$row->id) }}" style="display:none;">
                                                        @csrf
                                                        @method('put')
                                                    </form>
                                                </a>
